...
public class NtpTimeStamp implements java.io.Serializable, Comparable<NtpTimeStamp>
{
    ...
    */
    ...
    {
        return new NtpTimeStamp(toNtpTime(date));
    }
     ...
     * @throws NumberFormatException - if the string does not contain a parsable timestamp.
     */
    public static NtpTimeStamp parseNtpString(String s)
            throws NumberFormatException
    {
