...
public class StuffingDescriptor extends AtscDescriptor {

	private final byte[] stuffingBytes;

	public StuffingDescriptor(final byte[] b, final TableSection parent) {
		super(b, parent);
		stuffingBytes = getBytes(b, PRIVATE_DATA_OFFSET, descriptorLength);
	}

	@Override
	public KVP getJTreeNode(final int modus) {
		KVP t = super.getJTreeNode(modus);
		t.add(new KVP("stuffing_bytes", stuffingBytes));
		return t;
	}

	public byte[] getStuffingBytes() {
