...
public class SSUModuleTypeDescriptor extends DSMCCDescriptor {
	...
	public SSUModuleTypeDescriptor(byte[] b) {
		super(b);
		ssu_module_type = getInt(b, 2, 1, MASK_8BITS);
	}

	@Override
	public KVP getJTreeNode(int modus) {
		KVP t = super.getJTreeNode(modus);
		t.add(new KVP("SSU_module_type", ssu_module_type, getSSUModuleTypeString(ssu_module_type)));
		return t;
	}
