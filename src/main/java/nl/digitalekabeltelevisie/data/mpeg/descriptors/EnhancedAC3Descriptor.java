...
public class EnhancedAC3Descriptor extends Descriptor {
	...
	public EnhancedAC3Descriptor(byte[] b, TableSection parent) {
		super(b, parent);
		...
		mixinfoexists = Utils.getInt(b, 2, 1, 0x08) >> 3;
		substream1_flag = Utils.getInt(b, 2, 1, 0x04) >> 2;
		substream2_flag = Utils.getInt(b, 2, 1, 0x02) >> 1;
		substream3_flag = Utils.getInt(b, 2, 1, 0x01);
	...
	public KVP getJTreeNode(int modus){
		...
		t.add(new KVP("substream1_flag",substream1_flag));
		t.add(new KVP("substream2_flag",substream2_flag));
		t.add(new KVP("substream3_flag",substream3_flag));

		if(component_type_flag!=0){
			t.add(new KVP("component_type",component_type,AC3Descriptor.getComponentTypeString(component_type)));
		}
		if(bsid_flag!=0){
		...
		if(substream1_flag!=0){
			t.add(new KVP("substream1",substream1,"type of audio carried in independent substream 1 of the Enhanced AC-3 elementary stream"));
		}
		if(substream2_flag!=0){
			t.add(new KVP("substream2",substream2,"type of audio carried in independent substream 2 of the Enhanced AC-3 elementary stream"));
		}
		if(substream3_flag!=0){
			t.add(new KVP("substream3",substream3,"type of audio carried in independent substream 3 of the Enhanced AC-3 elementary stream"));
		}
