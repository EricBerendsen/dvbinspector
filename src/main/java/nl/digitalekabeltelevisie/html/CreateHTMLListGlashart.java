...
public class CreateHTMLListGlashart implements Runnable{

	private TransportStream transportStream;


	public CreateHTMLListGlashart() {
		super();
	...
	public static void main(final String[] args) {
		final CreateHTMLListGlashart inspector = new CreateHTMLListGlashart();
		inspector.run();
	}
	...
	private void writeHTML(final TransportStream tStream) {
		...
		try {
			final FileWriter fstream = new FileWriter("d:\\eric\\glashartveenendaal.html");
