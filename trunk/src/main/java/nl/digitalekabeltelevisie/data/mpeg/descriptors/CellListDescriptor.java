...
public class CellListDescriptor extends Descriptor {
	...
	public class Cell implements TreeNode{
		...
		public DefaultMutableTreeNode getJTreeNode(final int modus){
			...
			s.add(new DefaultMutableTreeNode(new KVP("cell_latitude",cellLatitude,CellLatitudeString(cellLatitude))));
			s.add(new DefaultMutableTreeNode(new KVP("cell_longitude",cellLongitude,CellLongitudeString(cellLongitude))));
			s.add(new DefaultMutableTreeNode(new KVP("cell_extent_of_latitude",cellExtentOfLatitude,CellLatitudeString(cellExtentOfLatitude))));
			s.add(new DefaultMutableTreeNode(new KVP("cell_extent_of_longitude",cellExtentOfLongitude,CellLongitudeString(cellExtentOfLongitude))));
	...
	public class SubCell implements TreeNode{
		...
		public DefaultMutableTreeNode getJTreeNode(final int modus){
			...
			s.add(new DefaultMutableTreeNode(new KVP("subcell_latitude",subcellLatitude,CellLatitudeString(subcellLatitude))));
			s.add(new DefaultMutableTreeNode(new KVP("subcell_longitude",subcellLongitude,CellLongitudeString(subcellLongitude))));
			s.add(new DefaultMutableTreeNode(new KVP("subcell_extent_of_latitude",subcellExtentOfLatitude,CellLatitudeString(subcellExtentOfLatitude))));
			s.add(new DefaultMutableTreeNode(new KVP("subcell_extent_of_longitude",subcellExtentOfLongitude,CellLongitudeString(subcellExtentOfLongitude))));
			return s;
		}
	}
	...
	public static String CellLatitudeString(final int latitude){
		int c=latitude;
		if(c>0x7FFF){
			c=c-0x10000;
		}
	...
	public static String CellLongitudeString(final int longitude){
		int c= longitude;
		if(c>0x7FFF){
			c=c-0x10000;
		}
