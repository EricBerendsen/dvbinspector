...
public class SDTsection extends TableSection {
	...
	public class Service implements TreeNode{
		...
		public DefaultMutableTreeNode getJTreeNode(final int modus){
			...
			//			DefaultMutableTreeNode descriptorListNode = new DefaultMutableTreeNode(new KVP("service_descriptors");
			//			for (Iterator<Descriptor> iter = descriptorList.iterator(); iter.hasNext();) {
			//				descriptorListNode.add(iter.next().getJTreeNode(modus));
			//			}
			//			t.add(descriptorListNode);
	...
	public DefaultMutableTreeNode getJTreeNode(final int modus){
		...
		//		DefaultMutableTreeNode servicesListNode = new DefaultMutableTreeNode(new KVP("services_loop");
		//		for (Iterator<Service> iter = serviceList.iterator(); iter.hasNext();) {
		//			servicesListNode.add(iter.next().getJTreeNode(modus));
		//		}
		//		t.add(servicesListNode);
		return t;
	}
