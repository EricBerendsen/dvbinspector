...
public class CreateHTMLListRekam implements Runnable{

	private TransportStream transportStream;


	public CreateHTMLListRekam() {
		super();
	...
	public static void main(final String[] args) {
		final CreateHTMLListRekam inspector = new CreateHTMLListRekam();
		inspector.run();
	}
	...
	private void writeHTML(final TransportStream tStream) {
		...
		try {
			final FileWriter fstream = new FileWriter("E:\\dtv\\kbg.html");
