...
public class MessageElementODAFreeFormatGroup extends MessageElement {

	public MessageElementODAFreeFormatGroup(final byte[] data, final int start) {
		super(data, start);
	}
	...
	protected int getApplicationGroupTypeCode() {
