...
public class CreateHTMLListDelta implements Runnable{

	private TransportStream transportStream;


	public CreateHTMLListDelta() {
		super();
	}
	...
	public static void main(final String[] args) {
		final CreateHTMLListDelta inspector = new CreateHTMLListDelta();
		inspector.run();
	}
	...
	private void writeHTML(final TransportStream tStream) {
		...
		try {
			final FileWriter fstream = new FileWriter("E:\\dtv\\delta.html");
