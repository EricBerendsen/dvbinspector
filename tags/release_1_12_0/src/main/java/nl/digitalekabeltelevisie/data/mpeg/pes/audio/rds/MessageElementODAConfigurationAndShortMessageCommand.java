...
public class MessageElementODAConfigurationAndShortMessageCommand extends MessageElement {

	public MessageElementODAConfigurationAndShortMessageCommand(final byte[] data, final int start) {
		super(data, start);
	}
