...
public class MessageElementTMC extends MessageElement {

	public MessageElementTMC(final byte[] data, final int start) {
		super(data, start);
	}
	...
	public DefaultMutableTreeNode getJTreeNode(final int modus) {
		final DefaultMutableTreeNode messageElement = new DefaultMutableTreeNode(new KVP("Message Element TMC"));
		...
		messageElement.add(new DefaultMutableTreeNode(new KVP("Data",data, 2,getMessageElementDataLength(),null)));
